  ...
  return <Container>
      <Grid container spacing={3} mt={6}>
        ...
        xs: 12
          ...
          <Banner2 isContentCenter ImageComponent={<LazyImage src={banner2} alt="banner" />} title="Sofa style  2024" />
        </Grid>
        ...
        xs: 12
          ...
          <Banner2 ImageComponent={<LazyImage src={banner4} alt="banner" />} title="Sale up to  30% off" />
        </Grid>
      </Grid>
    </Container>;
}